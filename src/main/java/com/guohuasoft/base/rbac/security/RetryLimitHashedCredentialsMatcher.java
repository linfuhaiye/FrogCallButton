package com.guohuasoft.base.rbac.security;
...
class RetryLimitHashedCredentialsMatcher extends HashedCredentialsMatcher {
     ...
     * 缓存
     */
    private final Cache<String, AtomicInteger> mRetryCache;

    RetryLimitHashedCredentialsMatcher(Cache<String, AtomicInteger> retryCache) {
    ...
    public boolean doCredentialsMatch(AuthenticationToken token, AuthenticationInfo info) {
        ...
        return token instanceof UsernamePasswordToken && doUsernamePasswordCredentialsMatch((UsernamePasswordToken) token, info);
    }
