...
import com.guohuasoft.base.monitor.mappers.LogInfoDao;
...
public class WebLogAspect {
     ...
     * 操作方法类型
     */
    private final String[] types = new String[]{"add", "edit", "del", "login", "logout", "other"};
    @Autowired
     ...
     * 拦截对象
     */
    @Pointcut("execution(public * com.guohuasoft.base.*.controllers..*(..))")
